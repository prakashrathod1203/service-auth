...
public class SwaggerConstants {
    ...
    public static final String MASTER_ORG_GROUP_SUB_GROUP_TAG =
            "Master - Organization > Group > SubGroup";
    public static final String MASTER_ORG_GROUP_SUB_GROUP_ROLE_TAG =
            "Master - Organization > Group > SubGroup > Role";
    ...
    public static final String FETCH_ORG_GROUP_SUB_GROUP_BY_ID_DESCRIPTION =
    ...
    public static final String FETCH_ORG_GROUP_SUB_GROUP_ROLE_BY_ID_DESCRIPTION =
            "Fetch Role by id";

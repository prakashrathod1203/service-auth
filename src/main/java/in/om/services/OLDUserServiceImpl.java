...
//
//	@Override
//	public OLDUser update(OLDUser user) {
//		return userRepository.save(user);
//	}
//
//	@Override
//	public void delete(OLDUser user) {
//		userRepository.delete(user);
//	}
//
//	@Override
//	public Optional<OLDUser> findADById(Long userId) {
...
//
//	@Override
//	public List<OLDUser> findAll(String status)  { // Status : 'A','I','AL'
...
//	   CriteriaQuery<OLDUser> criteriaQuery = criteriaBuilder.createQuery(OLDUser.class);
//	   Root<OLDUser> user = criteriaQuery.from(OLDUser.class);
...
//
//
//	   TypedQuery<OLDUser> query = entityManager.createQuery(criteriaQuery);
...
//
//	@Override
//	public Optional<OLDUser> findADByUserName(String userName , String phone) {
//		Optional<OLDUser> optional = userRepository.findADByusername(userName != "" ? userName : phone);
...
//	}
//	@Override
//	public Optional<OLDUser> getLoginUser() {
...
//
//	@Override
//	public Optional<OLDUser> findByPhone(String phone) {
...
//		OLDUser user = userRepository.findByusername(username).orElseThrow(() -> new RecordNotFoundException(Translator.toLocale("user.not.found", username)));
//

...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<?> handleResourceNotFoundException(
    ...
    public final ResponseEntity<Object> handleSQLSyntaxErrorException(
    ...
    public final ResponseEntity<Object> handleFileSizeLimitExceededException(Exception exception) {
        logException(exception, Exception.class);
        RestApiResponse response =
                new RestApiResponse("file.master.file.size.too.large", null, false);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        String error = ex.getBindingResult().getAllErrors().stream()
                .map(ObjectError::getDefaultMessage).findFirst().orElse("");
